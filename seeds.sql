...
VALUES (4, "Helin", "Rollins", 3, null);

INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
VALUES (5, "Annette", "Spooner", 4, null);

INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
VALUES (7, "Kellan", "Dant", 6, null);

INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
VALUES (10, "Keith", "Ferrell", 9, null);
...
INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
VALUES (2, "Daanyaal", "Wilde", 1, 3);

INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
VALUES (6, "Aneurin", "Bains", 5, 7);

INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
VALUES (8, "Oriana", "Soar", 7, 10);
